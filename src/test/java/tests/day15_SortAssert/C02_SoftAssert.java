...
public class C02_SoftAssert {
    ...
    public void tets01(){
       ...
       // 2. Sign in butonuna basin
        ...
        zeroWebAppPage.signInButtonu.click();
       ...
       // 7. “Purchase Foreign Currency” tusuna basin
        zeroWebAppPage.puchaseFCButonu.click();

       // 8. “Currency” drop down menusunden Eurozone’u secin
        Select select = new Select(zeroWebAppPage.currecyDropdown);
       ...
       // 9. soft assert kullanarak “Eurozone (euro)” secildigini test edin
        ...
        softAssert.assertEquals(actualDropdownSecim,expectedDropdownSecim,"eorozone secimi testi failed");
